...
import './FullDetailDisplay.css';
import MainContainerContainer from '../../containers/MainContainerContainer';

export class FullDetailDisplay extends Component {
  constructor() {
    super();
  }
...
export default MainContainerContainer(FullDetailDisplay);
